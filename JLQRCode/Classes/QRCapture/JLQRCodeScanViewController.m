...
@interface JLQRCodeScanViewController ()<AVCaptureMetadataOutputObjectsDelegate>
@property (nonatomic, strong) AVCaptureDeviceInput *input;
@property (nonatomic, strong) AVCaptureMetadataOutput *captureMetadataOutput;
@property (nonatomic, strong) AVCaptureSession *captureSession;
@property (nonatomic, strong) AVCaptureVideoPreviewLayer *videoPreivewLayer;

@property (nonatomic, strong) JLPreviewView *viewScan;


@end

@implementation JLQRCodeScanViewController
- (void)viewDidLoad {
    [super viewDidLoad];
...
- (JLPreviewView *)viewScan {
    if (_viewScan) return _viewScan;
    _viewScan = [[JLPreviewView alloc] initWithFrame:self.view.bounds];
    return _viewScan;
}
